...
label_dict = {
    'lung_n': 'benign lung tissue', 'lung_aca': 'lung adenocarcinoma', 'lung_scc': 'lung squamous cell carcinomas'
}
label_index_dict = {
...
path = 'path/to/dataset/pathasst_data/clip_zeroshot_cls/lung_image_sets'
